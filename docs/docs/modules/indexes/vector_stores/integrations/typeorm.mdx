...
For augmenting existing models in a PostgreSQL database with vector search, Langchain supports using [TypeORM](https://typeorm.io/) together with PostgreSQL and the [`pgvector`](https://github.com/pgvector/pgvector) Postgres extension.
